// Rain ported from https://www.shadertoy.com/view/ltffzl
...
void main()
{
    vec2 uv = gl_TexCoord[0].xy*textureSize(tex_scr, 0)/500.;
    vec2 UV = gl_TexCoord[0].xy;
    float T = mod(time, 1000);
    float t = T*.2;
    ...
    vec3 col = texture(tex_scr, UV+n).rgb;
